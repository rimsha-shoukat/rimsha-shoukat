                ...
                <div className="w-[77vw] h-auto flex flex-col">
                    ...
                    <div className="mt-10 w-full flex flex-row items-center justify-center gap-4">
                        ...
                        <div className="relative w-1/2 h-full flex items-center justify-center">
                            ...
                            <button className={`methods method1 ${clicked ? "clicked" : ""} absolute p-3 rounded-full bg-gray-800 hover:bg-gray-900/70 transition-colors duration-300 ease-in-out`}>
                            ...
                            <button className={`methods method4 ${clicked ? "clicked" : ""} absolute p-3 rounded-full bg-amber-800 hover:bg-amber-900/70 transition-colors duration-300 ease-in-out`}>
