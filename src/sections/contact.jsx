                    ...
                    <div className="mt-10 w-full flex flex-row items-center justify-center gap-4">
                        ...
                        <div className="w-1/2 flex flex-col items-start justify-center gap-8">
                            ...
                            <div className="relative flex items-center justify-center">
                                {/* Animated circle */}
                                <div className={`contactDiv ${active ? "block" : "hidden"} absolute w-48 h-48 dark:bg-[#f1f1f1]/10 bg-[#0e0e0e]/20 rounded-full`} />
                                {/* send button */}
                                ...
                                <button className={`contactBtn1 ${active ? "block" : "hidden"} absolute p-3 rounded-full bg-green-800 hover:bg-green-800/70 transition-colors duration-300 ease-in-out`}>
                                ...
                                <button className={`contactBtn2 ${active ? "block" : "hidden"} absolute p-3 rounded-full bg-red-800 hover:bg-red-800/70 transition-colors duration-300 ease-in-out`}>
                                ...
                                <button className={`contactBtn3 ${active ? "block" : "hidden"} absolute p-3 rounded-full bg-blue-800 hover:bg-blue-800/70 transition-colors duration-300 ease-in-out`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
                                </button>
                            </div>
                        </div>
                        {/* Image with links */}
                        <div className="w-1/2 h-auto border flex items-center justify-center">Image</div>
                    </div>
                </div>
            </section>
        </>
