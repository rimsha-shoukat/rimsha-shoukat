            ...
            <section className="w-full mt-25 mb-20 h-auto flex iteme-center justify-center">
                <div className="w-[77vw] h-auto flex flex-col">
                    ...
                    <div className="mt-10 w-full flex flex-row items-center justify-center gap-4">
                        ...
                        {/* Image with links */}
                        <div className="relative w-1/2 h-full border flex items-center justify-center">
                            {/* background circle */}
                            <div className={`ghostBg ${clicked ? "clicked" : ""} absolute w-80 h-80 dark:bg-[#f1f1f1]/10 bg-[#0e0e0e]/10 rounded-full`} />
                            {/* contact methods buttons */}
                            <button className={`methods method1 ${clicked ? "clicked" : ""} absolute p-3 rounded-full bg-black hover:bg-black/70 transition-colors duration-300 ease-in-out`}>
                            ...
                            <button className={`methods method2 ${clicked ? "clicked" : ""} absolute p-3 rounded-full bg-blue-800 hover:bg-blue-800/70 transition-colors duration-300 ease-in-out`}>
                            ...
                            <button className={`methods method3 ${clicked ? "clicked" : ""} absolute p-3 rounded-full bg-red-800 hover:bg-red-800/70 transition-colors duration-300 ease-in-out`}>
                            ...
                            <button className={`methods method4 ${clicked ? "clicked" : ""} absolute p-3 rounded-full bg-amber-950 hover:bg-blue-800/70 transition-colors duration-300 ease-in-out`}>
