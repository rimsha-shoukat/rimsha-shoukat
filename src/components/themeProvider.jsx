...
export function ThemeProvider() {
    ...
    return (
        <button onClick={() => setTheme(theme === 'light' ? 'dark' : 'light')} className="w-[2.6rem] h-auto border border-gray-400 dark:border-white/50 rounded-xl bg-[#f1f1f1] dark:bg-[#0a0a0a] flex flex-row items-center justify-between" title={`Switch to ${theme === 'light' ? 'dark' : 'light'} theme`}>
